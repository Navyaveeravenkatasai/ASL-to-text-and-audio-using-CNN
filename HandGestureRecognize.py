...
main = tkinter.Tk()
main.title("CNN based Deaf - Mute People Sign Language to Text and Speech")
...
font = ('times', 16, 'bold')
title = Label(main, text='CNN based Deaf - Mute People Sign Language to Text and Speech',anchor=W, justify=CENTER)
